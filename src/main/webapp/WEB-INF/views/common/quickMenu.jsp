...
function goodsDetail(){
	//퀵메뉴의 상품 썸네일 누르면 해당 상품정보 페이지로 이동하는 펑션
	var cur_goods_num=document.getElementById("cur_goods_num");
	...
	<div class="recent">
		...
		<!--   상품이 없습니다. -->
		 <c:choose>
			...
			<!-- goodscontrolelrimpl 의 addGoodsInQuick 메소드. -->
		         ...
		         <c:choose>
			      ...
			      <a href="javascript:goodsDetail();">
			  	         <img width="75" height="95" id="img_sticky"  
			                 ...
			                 <!-- 썸네일.두 는 넘어온 두개의 파라미터를 통해 썸네일을 생성하여 출력스트림에 태워서 클라이언트에게 전송하는 (다운로드하게만드는) 메소드임. -->
			      </a>
