package com.aboutcat.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.aboutcat.*.service.*.*(..)) or "
			+ "execution(* com.aboutcat.*.dao.*.*(..))")
	...
	@After("execution(* com.aboutcat.*.service.*.*(..)) or "
			+ "execution(* com.aboutcat.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.aboutcat.*.service.*.*(..)) or "
			+ "execution(* com.aboutcat.*.dao.*.*(..))")
